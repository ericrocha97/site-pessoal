                            ...
                            <div class="contato">
                                    <form action="login.php" method="post">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" name="email" id="email" class="form-control" aria-label="Nome" aria-describedby="basic-addon1">
                                            </div>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                     <span class="input-group-text" id="basic-addon1">Senha</span>
                                                </div>                          
                                                <input type="password" name="password" id="password" class="form-control" aria-label="Email" aria-describedby="basic-addon1">
                                            </div> 
                                            <small id="formhelp" class="form-text text-muted">Não tem uma conta? <a href="cadastro.html">Crie uma</a></small>                                   
                                            <br>
                                            <input type="submit" class="btn btn-success" value="Entrar" style="float: right;"/>
                                    </form>
                            </div>
                        </div>
